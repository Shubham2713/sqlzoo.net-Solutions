...
where goal.teamid<>'Ger' and ((goal.teamid=game.team1 and game.team2='GER') or (goal.teamid=team2 and game.team1='GER'))
...
select matchid,mdate,count(gtime) from game join goal on matchid=id and (teamid=team1 or teamid=team2)
where teamid="GER"
group by matchid,mdate
